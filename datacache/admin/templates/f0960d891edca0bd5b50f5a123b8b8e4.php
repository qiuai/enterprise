...
<table border="0" width="100%" bordercolor="#FFFFFF">
	<tr>
		...
		<td width="10%"><a id="btlimit_pid" class="infolink06" href="javascript:onlimit('pid','asc','#btlimit_pid','#limit_pid','#limit_slid','selectform','selectall','check_all')" hidefocus="true"><?php echo $this->_tpl_vars['ST']['sitemain_text_pid'] ?></a><span id="limit_pid" class="limitdesc displaynone"></span></td>
		<td width="10%"><a id="btlimit_slid" class="infolink06" href="javascript:onlimit('slid','asc','#btlimit_slid','#limit_slid','#limit_pid','selectform','selectall','check_all')"  hidefocus="true"><?php echo $this->_tpl_vars['ST']['sitemain_text_id'] ?></a><span id="limit_slid" class="limitdesc"></span></td>
		<td width="40%"><?php echo $this->_tpl_vars['ST']['sitemain_text_name'] ?></td>
		<td width="35%"><?php echo $this->_tpl_vars['ST']['language_text_set'] ?></td>
	</tr>
</table>
<?php } ?>
