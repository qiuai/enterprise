			            ...
			            <table style="width:100%">
							<tr>
								...
								<table class="formtablewin">
									...
									<tr>
										<td class="center" style="padding-top:30px;"><input type="submit" name="Submit" value="<?php echo $this->_tpl_vars['bottonName'] ?>" class="buttonface" onclick="javascript:location.href='<?php echo $this->_tpl_vars['linkURL'] ?>';" title="<?php echo $this->_tpl_vars['bottonName'] ?>"/></td>
									</tr>
								</table>
								</td>
							</tr>
