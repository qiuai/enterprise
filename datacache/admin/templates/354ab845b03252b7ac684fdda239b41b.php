			...
			<div class="maneditcontent">
				<table class="formtable">
					...
					<tr class="trstyle2 <?php if($this->_tpl_vars['styleid']!=3){ ?>displaynone<?php } ?>">
						...
						<td width="85%" class="trtitle02">
							<input type="radio" value="0" name="isline" onclick="ondisplayother('islinediv','trstyle2 displaytrue','typeurldiv','trstyle2 displaynone');"/> <?php echo $this->_tpl_vars['ST']['typemanage_type_add_styleid_isline_0'] ?>&nbsp;
							<input type="radio" value="1" name="isline" onclick="ondisplayother('islinediv','trstyle2 displaynone','typeurldiv','trstyle2 displaytrue')" checked="checked"/> <?php echo $this->_tpl_vars['ST']['typemanage_type_add_styleid_isline_1'] ?>
					...
					<tr class="trstyle2 <?php if($this->_tpl_vars['styleid']!=3){ ?>displaynone<?php } ?>" id="typeurldiv">
					...
					<tr class="trstyle2">
						...
						<td width="85%" class="trtitle02">
							<ul class="addpiclist">
								<li id="addsrlipic"><a title="<?php echo $this->_tpl_vars['ST']['selectfile_botton'] ?>" onclick="javascript:parent.windowsdig('<?php echo $this->_tpl_vars['ST']['filemanage_select_title'] ?>','iframe:index.php?archive=filemanage&action=filewindow&listfunction=filelist&filetype=img&checkfrom=picshow&getbyid=addsrlipic&fileinputid=typepic&maxselect=1&iframename='+self.frameElement.getAttribute('name'),'900px','480px','iframe')" href="#body"><p><img id="addsrcpic" src="templates/images/pic.png"></p></a></li>
							</ul>
					...
					<tr class="trstyle2 <?php if($this->_tpl_vars['styleid']==3 || $this->_tpl_vars['styleid']==4){ ?>displaynone<?php } ?>" id="pagemaxdiv2">
						...
						<td width="85%" class="trtitle02">
							<input type="radio" value="1" name="isorderby" checked="checked"/> <?php echo $this->_tpl_vars['ST']['typemanage_type_add_isorderby_1'] ?>&nbsp;
							<input type="radio" value="0" name="isorderby"/> <?php echo $this->_tpl_vars['ST']['typemanage_type_add_isorderby_0'] ?>
						</td>
					</tr>
					<tr class="trstyle2 <?php if($this->_tpl_vars['styleid']==3 || $this->_tpl_vars['styleid']==4){ ?>displaynone<?php } ?>" id="pagemaxdiv3">
						...
						<td width="85%" class="trtitle02">
							<input type="radio" value="1" name="ordertype" checked="checked"/> <?php echo $this->_tpl_vars['ST']['typemanage_type_add_ordertype_1'] ?>&nbsp;
							<input type="radio" value="2" name="ordertype"/> <?php echo $this->_tpl_vars['ST']['typemanage_type_add_ordertype_2'] ?>
						</td>
					</tr>
					<tr class="trstyle2">
