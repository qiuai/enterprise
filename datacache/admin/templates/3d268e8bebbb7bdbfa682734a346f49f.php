...
<script type="text/javascript">
	...
	function formverify(formData, jqForm, options) {
		...
		<?php if($this->_tpl_vars['typeread']['styleid']!=4){ ?>
					...
					<?php if (count($this->_tpl_vars['modelatt'])>0){$divid_list=1;for($list=0;$list<count($this->_tpl_vars['modelatt']); $list++){?>
						<tr class="trstyle2">
							...
							<td class="trtitle02">
								...
								<ul class="addpiclist">
									<?php if($this->_tpl_vars['modelatt'][$list]['attrvalue']!=''){ ?>
									<li id="addsrli<?php echo $this->_tpl_vars['modelatt'][$list]['attrname'] ?>"><a title="<?php echo $this->_tpl_vars['ST']['remimages_botton'] ?>" ondblclick="removerpic('addsrli<?php echo $this->_tpl_vars['modelatt'][$list]['attrname'] ?>','<?php echo $this->_tpl_vars['modelatt'][$list]['attrname'] ?>')" href="#body"><p><img id="addsr<?php echo $this->_tpl_vars['modelatt'][$list]['attrname'] ?>" width="100" height="100" src="<?php echo $this->_tpl_vars['path'] ?><?php echo $this->_tpl_vars['modelatt'][$list]['attrvalue'] ?>"></p></a></li>
									<?php }else{ ?>
									<li id="addsrli<?php echo $this->_tpl_vars['modelatt'][$list]['attrname'] ?>"><a title="<?php echo $this->_tpl_vars['ST']['selectfile_botton'] ?>" onclick="javascript:parent.windowsdig('<?php echo $this->_tpl_vars['ST']['filemanage_select_title'] ?>','iframe:index.php?archive=filemanage&action=filewindow&listfunction=filelist&filetype=img&checkfrom=picshow&getbyid=addsrli<?php echo $this->_tpl_vars['modelatt'][$list]['attrname'] ?>&fileinputid=<?php echo $this->_tpl_vars['modelatt'][$list]['attrname'] ?>&maxselect=1&iframename='+self.frameElement.getAttribute('name'),'900px','480px','iframe')" href="#body"><p><img id="addsr<?php echo $this->_tpl_vars['modelatt'][$list]['attrname'] ?>" width="100" height="100" src="templates/images/pic.png"></p></a></li>
									<?php } ?>
								</ul>
