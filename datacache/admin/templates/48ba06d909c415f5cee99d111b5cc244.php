			...
			<div class="maneditcontent">
				<table class="formtable">
					...
					<tr class="trstyle2">
						...
						<td class="trtitle02"><input type="password" name="password" size="50" maxlength="30"  class="infoInput"/> <span class="cautiontitle"><?php echo $this->_tpl_vars['ST']['mangerlist_add_password_mess'] ?></span></td>
					</tr>
					<tr class="trstyle2">
					...
					<tr class="trstyle2">
						...
						<td class="trtitle02">
							<input type="radio" value="1" name="isremote" checked="checked"> <?php echo $this->_tpl_vars['ST']['open_botton_title'] ?>&nbsp;
							<input type="radio" value="0" name="isremote"> <?php echo $this->_tpl_vars['ST']['close_botton_title'] ?>&nbsp;
