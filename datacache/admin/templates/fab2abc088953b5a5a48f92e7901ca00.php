...
<div id="downbotton">
	<div id="subbotton">
		<table border="0" width="100%">
			<tr>
				<td id="right"><input type="submit" name="Submit" value="<?php echo $this->_tpl_vars['ST']['botton_del'] ?>" class="buttonface" title="<?php echo $this->_tpl_vars['ST']['botton_del'] ?>"/></td>
				<td id="left" class="padding-left5"><input type="reset" name="reset" value="<?php echo $this->_tpl_vars['ST']['botton_del_reset'] ?>" onclick="javascript:resetwindow();" class="buttonface"  title="<?php echo $this->_tpl_vars['ST']['botton_del_reset'] ?>"/></td>
			</tr>
		</table>
	</div>
</div>
