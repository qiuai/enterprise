...
<div class="center">
  ...
  <div class="tiao">
    <div class="tiao_1">产品应用/Products</div>
    <div class="tiao_2">新闻中心/News</div>
  </div>
  <div class="cpxw">
     <div class="cp_left">
         <div class="cp_l_1">
           <div class="cpyy_1">
           214adb21252b0af7b03s214s9typelist|mid:3,tid:49,att:1,level:2|60af7b03s21fs
				<?php if (count($this->_tpl_vars['array'])>0){$divid_i=1;for($i=0;$i<count($this->_tpl_vars['array']); $i++){?>
...
function hover(id, num)
{
	for(var i=0;i<num;i++)
	{
		...
		if(id == i)
		{
         ...
         <div class="cp_l_2"><a href="4adb4912cd04e6fd3type|5|link4adb4912cd04e6fd3">Read more</a></div>    
     </div>
     <div class="xw_right">
         <div class="xw_r_1">
           <ul>
         ...
         <div class="xw_r_2"><a href="4adb4912cd04e6fd3type|4|link4adb4912cd04e6fd3">Read more</a></div>
     </div>
