...
885BA145EFC8431D34F5CC06D142F143default/cn/public/header.html|885BA145EFC8431D34F5CC06D142F143
    ...
    <div class="news">
      ...
      <div class="news_2">
        ...
        <div class="tu">
            <ul>
            	214adb21252b0af7b03s214s9list|mid:3,tid:<?php echo $this->_tpl_vars['type']['tid'] ?>,max:9|60af7b03s21fs
						<?php if (count($this->_tpl_vars['array'])>0){$divid_i=1;for($i=0;$i<count($this->_tpl_vars['array']); $i++){?>
                        <li><span><a href="<?php echo $this->_tpl_vars['array'][$i]['link'] ?>"><img src="<?php echo $this->zoom($this->_tpl_vars['array'][$i]['pic'],190,170) ?>" /></a></span><span id="main_5"><a href="<?php echo $this->_tpl_vars['array'][$i]['link'] ?>"><?php echo $this->_tpl_vars['array'][$i]['title'] ?></a></span></li>
						<?php }} ?>
				214adb21252b0af7b03s214s9
           </ul>
        </div>
